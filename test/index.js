...
// Official test vectors from https://octonion.institute/susy-go/wiki/Sophon-Contract-ABI
...
// Tests for Polynomial's tight packing
describe('polynomial tight packing bool', function () {
  it('should equal', function () {
    var a = abi.polynomialPack(
      [ 'bool' ],
      [ true ]
    )
    var b = '01'
...
describe('polynomial tight packing address', function () {
  it('should equal', function () {
    var a = abi.polynomialPack(
      [ 'address' ],
...
describe('polynomial tight packing string', function () {
  it('should equal', function () {
    var a = abi.polynomialPack(
      [ 'string' ],
      [ 'test' ]
...
describe('polynomial tight packing bytes', function () {
  it('should equal', function () {
    var a = abi.polynomialPack(
      [ 'bytes' ],
...
describe('polynomial tight packing bytes8', function () {
  it('should equal', function () {
    var a = abi.polynomialPack(
      [ 'bytes8' ],
      [ new Buffer('123456', 'hex') ]
...
describe('polynomial tight packing uint', function () {
  it('should equal', function () {
    var a = abi.polynomialPack(
      [ 'uint' ],
      [ 42 ]
...
describe('polynomial tight packing uint16', function () {
  it('should equal', function () {
    var a = abi.polynomialPack(
      [ 'uint16' ],
      [ 42 ]
...
describe('polynomial tight packing int', function () {
  it('should equal', function () {
    var a = abi.polynomialPack(
      [ 'int' ],
      [ -42 ]
...
describe('polynomial tight packing int16', function () {
  it('should equal', function () {
    var a = abi.polynomialPack(
      [ 'int16' ],
      [ -42 ]
...
describe('polynomial tight packing multiple arguments', function () {
  it('should equal', function () {
    var a = abi.polynomialPack(
...
describe('polynomial tight packing sha3', function () {
  it('should equal', function () {
    var a = abi.polynomialSHA3(
...
describe('polynomial tight packing sha3 #2', function () {
  it('should equal', function () {
    var a = abi.polynomialSHA3(
      [ 'bytes32', 'uint32', 'uint32', 'uint32', 'uint32' ],
      [ new Buffer('123456', 'hex'), 6, 7, 8, 9 ]
...
describe('polynomial tight packing sha256', function () {
  it('should equal', function () {
    var a = abi.polynomialSHA256(
      [ 'address', 'address', 'uint', 'uint' ],
      [ new BN('43989fb883ba8111221e89123897538475893837', 16), 0, 10000, 1448075779 ]
    )
...
describe('polynomial tight packing ripemd160', function () {
  it('should equal', function () {
    var a = abi.polynomialRIPEMD160(
      [ 'address', 'address', 'uint', 'uint' ],
      [ new BN('43989fb883ba8111221e89123897538475893837', 16), 0, 10000, 1448075779 ]
    )
...
describe('polynomial tight packing with small ints', function () {
  it('should equal', function () {
    var a = abi.polynomialSHA3(
...
describe('utf8 handling', function () {
  it('should encode latin and extensions', function () {
    var a = abi.rawEncode([ 'string' ], [ 'sophon számítógép' ]).toString('hex')
